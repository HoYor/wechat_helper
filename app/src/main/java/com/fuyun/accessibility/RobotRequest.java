...
public class RobotRequest {
    ...
    /**
     * reqType : 0
     * perception : {"inputText":{"text":"附近的酒店"},"inputImage":{"url":"imageUrl"},
    ...
    public RobotRequest(String apiKey,String userId, String text) {
        this.reqType = 0;
        PerceptionBean perceptionBean = new PerceptionBean();
        perceptionBean.setInputText(new PerceptionBean.InputTextBean(text));
